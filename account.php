...
?>
<body style="background:url(css/gal2.jpg); background-size: cover;">
...
include_once 'dbConnection.php';
echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="#" class="log log1">'.$name.'</a>&nbsp;|&nbsp;<a href="logout.php?q=account.php" <button class=" btn btn-danger " style =" position:relative;right:30px;"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
}?>
</div>
</div></div>
<div class="bg">
...
echo '<div class="panel"style="background:#D6EAF8";"margin:5%">';
...
echo  '<div class="panel"style="background:#D6EAF8;">
<center><h1 class="title" style="color:black"><b>Result</b></h1><center><br /><table class="table table-striped title1" style="font-size:20px;font-weight:1000;">';
...
{
$s=$row['score'];
echo '<tr style="color:#2874A6"><td>Overall Score&nbsp;<span  aria-hidden="true"></span></td><td>'.$s.'</td></tr>';
}
echo '</table></div>';
...
echo  '<div class="panel title" style="background:#D6EAF8;">
<table class="table table-striped title1" >
<tr style="color:blue"><td><b>S.N.</b></td><td><b>Quiz</b></td><td><b>Question Solved</b></td><td><b>Right</b></td><td><b>Wrong<b></td><td><b>Score</b></td>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$eid=$row['eid'];
