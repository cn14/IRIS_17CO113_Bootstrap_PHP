...
<body  style="background:url(css/gal.jpeg); background-size: cover;">
<div class="header" style="background:#154360 ;">
<div class="row">
<div class="col-lg-6">
...
include_once 'dbConnection.php';
echo '<span class="pull-right top " ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="#" class="log log1">'.$name.'</a>&nbsp;<a href="logout.php?q=account.php" <button class=" btn btn-danger " style =" position:relative;right:30px;"><span class="glyphicon pxyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
}?>
...
<!--navigation menu-->
<nav class="navbar navbar-default title1" style="background: #AED6F1;">
...
echo  '<div class="panel" style="background:#D6EAF8;"><div class="table-responsive"><table class="table table-striped title1">
...
echo  '<div class="panel title"style="background:#D6EAF8;><div class="table-responsive">
<table class="table table-striped title1" >
<tr style="color:blue"><td><b>Rank</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>College</b></td><td><b>Score</b></td></tr>';
$c=0;
...
$c++;
echo '<tr><td style=""><b>'.$c.'</b></td><td>'.$name.'</td><td>'.$gender.'</td><td>'.$college.'</td><td>'.$s.'</td><td>';
}
echo '</table></div></div>';}
...
echo '<div class="panel"style="background:#D6EAF8;<a title="Back to Archive" href="update.php?q1=2"><b><span class="glyphicon glyphicon-level-up" aria-hidden="true"></span></b></a><h2 style="text-align:center; margin-top:-15px;font-family: "Ubuntu", sans-serif;"><b>'.$subject.'</b></h1>';
...
echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px; color:white;"><b>Create Quiz</b></span><br /><br />
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="right" name="right" placeholder="Marks on right answer" class="form-control input-md" min="0" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="wrong" name="wrong" placeholder="Marks on wrong answer (without sign)" class="form-control input-md" min="0" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="time" name="time" placeholder="Time limit for test (min)" class="form-control input-md" min="1" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12"> 
    <input  type="submit" style="margin-left:45%" class="btn btn-success" value="Submit" class="btn btn-primary"/>
  </div>
</div>
...
echo ' 
<div class="row">
<span class="title1" style="color:white;margin-left:40%;font-size:30px;"><b>Question Details</b></span><br /><br />
...
';
 ...
 for($i=1;$i<=@$_GET['n'];$i++)
 {
echo '<b style =" color:white;">Question &nbsp;'.$i.'&nbsp;:</><br /><!-- Text input-->
<div class="form-group">
...
while($row = mysqli_fetch_array($result)) {
  ...
  $eid = $row['eid'];
  echo '<tr><td>'.$c++.'</td><td>'.$title.'</td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td>
  <td><b><a href="update.php?q=rmquiz&eid='.$eid.'" <button class="btn btn-danger" style="margin:0px;position:relative;right:-30px;"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Remove</b></span></a></b></td></tr>';
}
$c=0;
echo '</table></div></div>';
