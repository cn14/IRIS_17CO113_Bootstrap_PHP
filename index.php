...
<div class="col-md-3 panel" style="background: #D6EAF8 ; ">
<!-- sign in form begins -->  
...
<div class="form-group">
  ...
  <div class="col-md-12"> 
    <input  type="submit" <button class="btn btn-primary btn-lg btn-block" value="sign up"/>
  </div>
</div>
...
<!--Footer start-->
<div class="footer" style="background: #D6EAF8;">
<!-- <div class="col-md-3 box">
<a href="http://www.projectworlds/online-examination" target="_blank">About us</a>
</div> -->
<div class="col-md-3 ">
<a href="#"<button class="btn btn-primary btn-lg " style = "position:relative; left:130%;  "data-toggle="modal" data-target="#login"> Login as Admin</a></div>
<!-- <div class="col-md-3 box">
